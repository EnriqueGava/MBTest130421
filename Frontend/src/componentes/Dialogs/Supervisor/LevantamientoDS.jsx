...
import { getImgs, LevSup, FirmaSup, checkSup } from '../../../functions';
...
const LevantamientoD = (props) => {
    ...
    console.log(props.idSup)
	 console.log(props.firma)
...
const Signed =() => {
    FirmaSup(props.idSup,imageData);
	console.log("Guardando firma");
	LevSup(props.numOrden,props.idSup);
    handleClose();
  }
  ...
  const DigitalSignature =(
	...
	const checkFirma = async() => {
		let q= await checkSup(props.idSup);
		//console.log(q.firma);
        if( q.firma == null)
			handleClickOpen();
		else{
